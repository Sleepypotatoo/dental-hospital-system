        ...
        <el-card>
            ...
            <el-table :data="doctorData" size="small" stripe style="width: 100%" border>
                ...
                <el-table-column label="操作" width="200" fixed="right">
                    <template slot-scope="scope">
                        ...
                        >
                            <i class="iconfont icon-delete-button" style="font-size: 12px;"></i>
                        </el-button>
                    </template>
                </el-table-column>
            </el-table>
            ...
            <el-dialog title="添加医生" :visible.sync="addFormVisible">
                <el-form :model="addForm" :rules="rules" ref="ruleForm">
                    ...
                    <el-form-item label="职位" label-width="80px" prop="dPost">
                        <el-select v-model="addForm.dPost" placeholder="请选择职位">
                            <el-option
                                v-for="post in posts"
                                :key="post"
                                :label="post"
                    ...
                    <el-form-item label="科室" label-width="80px" prop="dSection">
                        <el-select v-model="addForm.dSection" placeholder="请选择科室">
                            <el-option
            ...
            <el-dialog title="修改医生信息" :visible.sync="modifyFormVisible">
                <el-form :model="modifyForm" :rules="rules" ref="ruleForm">
                    ...
                    <el-form-item label="职位" label-width="80px" prop="dPost">
                        <el-select v-model="modifyForm.dPost" placeholder="请选择职位">
                            <el-option
                                v-for="post in posts"
                                :key="post"
                                :label="post"
                    ...
                    <el-form-item label="科室" label-width="80px" prop="dSection">
                        <el-select v-model="modifyForm.dSection" placeholder="请选择科室">
                            <el-option
                                v-for="section in sections"
                                :key="section"
                                :label="section"
                ...
                <div slot="footer" class="dialog-footer">
                    ...
                    <el-button size="mini" type="primary"  @click="modifyDoctor('ruleForm')" style="font-size: 18px;">
                        <i class="iconfont icon-sure-button" style="font-size: 20px;"></i> 确 定
                    </el-button>
                </div>
            </el-dialog>
                    ...
                    request
                       .get("admin/modifyDoctor", {
                            params: {
                                ...
                                dPassword: this.modifyForm.dPassword,
